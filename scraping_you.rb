...
get '/view_eventlist' do
  ...
  doc.xpath("//*[@id=\"left\"]").each do |tr|
    event_location = tr.children.search("td[@class=\"place\"]").text rescue "(no data)"
...
# #     regist_space = tr.children("td[@rowspan][1]").text rescue "(no data)"
